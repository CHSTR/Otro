class OfertaLaboral < ApplicationRecord
	...
	#validates :oferta_d
	validates :cargo, format: { with: /\A[a-zA-Zá-é-í-ó-ú ]+\z/,message: "¡Solo caracteres!"}, length: {minimum: 3, message:"El nombre es muy corto."}
	validates :empresa,format: { with: /\A[a-zA-Zá-é-í-ó-ú ]+\z/,message: "¡Solo caracteres!"}, length: {minimum: 3, message:"El nombre es muy corto."}
